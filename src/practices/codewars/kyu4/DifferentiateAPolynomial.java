...
public class DifferentiateAPolynomial {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(differentiate("-21x^5+3x^3",12398));
    System.out.println(differentiate("x^2",59884848483559L));
    System.out.println(differentiate("-7x^5+22x^4-55x^3-94x^2+87x-56",-3));
  }
}
